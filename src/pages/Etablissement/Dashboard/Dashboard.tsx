// src/pages/Etablissement/Dashboard/Dashboard.tsx
...
const Dashboard: React.FC = () => {
  ...
  const [showWelcome, setShowWelcome] = useState(
    location.pathname === '/etablissement/dashboard'
  );
  ...
  return (
    <div className={styles.layout}>
      <aside className={styles.sidebar}>
        ...
        <button className={styles.titleBtn} onClick={goHomeTab}>
        ...
        <nav className={styles.nav}>
          <button
            onClick={() => {
              navigate('/etablissement/dashboard/renseignementsperiodiquesform');
          ...
          <button
            onClick={() => {
              navigate('/etablissement/dashboard/offreemploiform');
              setShowWelcome(false);
            }}
          >
            Offre d’emploi
          ...
          <button
            onClick={() => {
              navigate('/etablissement/dashboard/reouvertureform');
              setShowWelcome(false);
            }}
          >
            Réouverture
          ...
          <button
            onClick={() => {
              navigate('/etablissement/dashboard/fermetureform');
              setShowWelcome(false);
            }}
          >
            Fermeture
