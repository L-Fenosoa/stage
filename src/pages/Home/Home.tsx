...
// import Navbar from '../../components/Navbar/Navbar'; ← **SUPPRIMÉ**
...
const sections: Section[] = [
  {
    ...
    text: 'Bienvenue sur la plateforme qui dynamise l’emploi et la formation locale, pour un avenir prometteur de notre région.',
    img: imgIntro,
    hoverTitle: 'Maison de L’Emploi et de la Formation dans la Région Haute-Matsiatra',
    hoverText:
  ...
  },
  {
    ...
    text: 'Découvrez les offres d’emploi, postulez en un clic et suivez vos candidatures en temps réel.',
    img: imgTrav,
  ...
  },
  {
    ...
    text: 'Publiez vos offres, gérez vos candidatures et trouvez rapidement le profil idéal.',
    img: imgEtab,
